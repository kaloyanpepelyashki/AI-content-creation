...
class GPTScriptGenerator extends GPTModel {
  ...
  /** The following method generates a more generic content, based on a pre-set prompt in combination of ideas, that can be passed as a parameter.
   *
   */
...
export default GPTScriptGenerator;
