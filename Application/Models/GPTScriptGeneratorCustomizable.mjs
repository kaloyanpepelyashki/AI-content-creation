import GPTScriptGenerator from "./GPTScriptGenerator.mjs";
...
class GPTScriptGeneratorCustomizable extends GPTScriptGenerator {
  ...
  constructor() {
    try {
      super();
      this.#modelSystemMessage = super.getModelSystemMessage();
      this.#model = super.getGenerativeModel();
    } catch (e) {
      throw new Error(
        "Error in GPTScriptGeneratorCustomizable constructor: ",
        e
      );
    }
  }
...
export default GPTScriptGeneratorCustomizable;
